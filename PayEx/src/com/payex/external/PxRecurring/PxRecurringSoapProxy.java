...
public class PxRecurringSoapProxy implements com.payex.external.PxRecurring.PxRecurringSoap {
  private String _endpoint = null;
  private com.payex.external.PxRecurring.PxRecurringSoap pxRecurringSoap = null;
  ...
  private void _initPxRecurringSoapProxy() {
    try {
      pxRecurringSoap = (new com.payex.external.PxRecurring.PxRecurringLocator()).getPxRecurringSoap();
  ...
  public com.payex.external.PxRecurring.PxRecurringSoap getPxRecurringSoap() {
    if (pxRecurringSoap == null)
      _initPxRecurringSoapProxy();
