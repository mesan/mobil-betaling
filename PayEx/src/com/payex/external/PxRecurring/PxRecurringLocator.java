...
public class PxRecurringLocator extends org.apache.axis.client.Service implements com.payex.external.PxRecurring.PxRecurring {
    ...
    private java.lang.String PxRecurringSoap_address = "https://external.payex.com/pxagreement/pxrecurring.asmx";
    ...
    public com.payex.external.PxRecurring.PxRecurringSoap getPxRecurringSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.payex.external.PxRecurring.PxRecurringSoap getPxRecurringSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxRecurring.PxRecurringSoapStub _stub = new com.payex.external.PxRecurring.PxRecurringSoapStub(portAddress, this);
    ...
    private java.lang.String PxRecurringSoap12_address = "https://external.payex.com/pxagreement/pxrecurring.asmx";
    ...
    public com.payex.external.PxRecurring.PxRecurringSoap getPxRecurringSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.payex.external.PxRecurring.PxRecurringSoap getPxRecurringSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxRecurring.PxRecurringSoap12Stub _stub = new com.payex.external.PxRecurring.PxRecurringSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.payex.external.PxRecurring.PxRecurringSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxRecurring.PxRecurringSoapStub _stub = new com.payex.external.PxRecurring.PxRecurringSoapStub(new java.net.URL(PxRecurringSoap_address), this);
                _stub.setPortName(getPxRecurringSoapWSDDServiceName());
                return _stub;
            }
            if (com.payex.external.PxRecurring.PxRecurringSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxRecurring.PxRecurringSoap12Stub _stub = new com.payex.external.PxRecurring.PxRecurringSoap12Stub(new java.net.URL(PxRecurringSoap12_address), this);
                _stub.setPortName(getPxRecurringSoap12WSDDServiceName());
                return _stub;
            }
        }
