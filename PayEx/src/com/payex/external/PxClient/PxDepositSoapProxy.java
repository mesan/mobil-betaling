...
public class PxDepositSoapProxy implements com.payex.external.PxClient.PxDepositSoap {
  private String _endpoint = null;
  private com.payex.external.PxClient.PxDepositSoap pxDepositSoap = null;
  ...
  private void _initPxDepositSoapProxy() {
    try {
      pxDepositSoap = (new com.payex.external.PxClient.PxDepositLocator()).getPxDepositSoap();
  ...
  public com.payex.external.PxClient.PxDepositSoap getPxDepositSoap() {
    if (pxDepositSoap == null)
      _initPxDepositSoapProxy();
