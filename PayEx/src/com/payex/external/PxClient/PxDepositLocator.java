...
public class PxDepositLocator extends org.apache.axis.client.Service implements com.payex.external.PxClient.PxDeposit {
    ...
    private java.lang.String PxDepositSoap_address = "https://external.payex.com/pxclient/pxdeposit.asmx";
    ...
    public com.payex.external.PxClient.PxDepositSoap getPxDepositSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxClient.PxDepositSoapStub _stub = new com.payex.external.PxClient.PxDepositSoapStub(portAddress, this);
    ...
    private java.lang.String PxDepositSoap12_address = "https://external.payex.com/pxclient/pxdeposit.asmx";
    ...
    public com.payex.external.PxClient.PxDepositSoap getPxDepositSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxClient.PxDepositSoap12Stub _stub = new com.payex.external.PxClient.PxDepositSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.payex.external.PxClient.PxDepositSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxClient.PxDepositSoapStub _stub = new com.payex.external.PxClient.PxDepositSoapStub(new java.net.URL(PxDepositSoap_address), this);
                _stub.setPortName(getPxDepositSoapWSDDServiceName());
                return _stub;
            }
            if (com.payex.external.PxClient.PxDepositSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxClient.PxDepositSoap12Stub _stub = new com.payex.external.PxClient.PxDepositSoap12Stub(new java.net.URL(PxDepositSoap12_address), this);
                _stub.setPortName(getPxDepositSoap12WSDDServiceName());
                return _stub;
            }
        }
