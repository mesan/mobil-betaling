...
public class PxAccountSoapProxy implements com.payex.external.PxClient.PxAccountSoap {
  private String _endpoint = null;
  private com.payex.external.PxClient.PxAccountSoap pxAccountSoap = null;
  ...
  private void _initPxAccountSoapProxy() {
    try {
      pxAccountSoap = (new com.payex.external.PxClient.PxAccountLocator()).getPxAccountSoap();
  ...
  public com.payex.external.PxClient.PxAccountSoap getPxAccountSoap() {
    if (pxAccountSoap == null)
      _initPxAccountSoapProxy();
