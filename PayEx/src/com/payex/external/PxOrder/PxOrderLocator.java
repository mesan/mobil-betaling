...
public class PxOrderLocator extends org.apache.axis.client.Service implements com.payex.external.PxOrder.PxOrder {
    ...
    private java.lang.String PxOrderSoap_address = "https://external.payex.com/pxorder/pxorder.asmx";
    ...
    public com.payex.external.PxOrder.PxOrderSoap getPxOrderSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.payex.external.PxOrder.PxOrderSoap getPxOrderSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxOrder.PxOrderSoapStub _stub = new com.payex.external.PxOrder.PxOrderSoapStub(portAddress, this);
    ...
    private java.lang.String PxOrderSoap12_address = "https://external.payex.com/pxorder/pxorder.asmx";
    ...
    public com.payex.external.PxOrder.PxOrderSoap getPxOrderSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.payex.external.PxOrder.PxOrderSoap getPxOrderSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxOrder.PxOrderSoap12Stub _stub = new com.payex.external.PxOrder.PxOrderSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.payex.external.PxOrder.PxOrderSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxOrder.PxOrderSoapStub _stub = new com.payex.external.PxOrder.PxOrderSoapStub(new java.net.URL(PxOrderSoap_address), this);
                _stub.setPortName(getPxOrderSoapWSDDServiceName());
                return _stub;
            }
            if (com.payex.external.PxOrder.PxOrderSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxOrder.PxOrderSoap12Stub _stub = new com.payex.external.PxOrder.PxOrderSoap12Stub(new java.net.URL(PxOrderSoap12_address), this);
                _stub.setPortName(getPxOrderSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://external.payex.com/PxOrder/", "PxOrder");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://external.payex.com/PxOrder/", "PxOrderSoap"));
            ports.add(new javax.xml.namespace.QName("http://external.payex.com/PxOrder/", "PxOrderSoap12"));
        }
