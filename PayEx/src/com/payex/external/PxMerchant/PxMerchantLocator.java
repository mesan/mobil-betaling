...
public class PxMerchantLocator extends org.apache.axis.client.Service implements com.payex.external.PxMerchant.PxMerchant {
    ...
    private java.lang.String PxMerchantSoap_address = "https://external.payex.com/pxmerchant/pxmerchant.asmx";
    ...
    public com.payex.external.PxMerchant.PxMerchantSoap getPxMerchantSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxMerchant.PxMerchantSoapStub _stub = new com.payex.external.PxMerchant.PxMerchantSoapStub(portAddress, this);
    ...
    private java.lang.String PxMerchantSoap12_address = "https://external.payex.com/pxmerchant/pxmerchant.asmx";
    ...
    public com.payex.external.PxMerchant.PxMerchantSoap getPxMerchantSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxMerchant.PxMerchantSoap12Stub _stub = new com.payex.external.PxMerchant.PxMerchantSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.payex.external.PxMerchant.PxMerchantSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxMerchant.PxMerchantSoapStub _stub = new com.payex.external.PxMerchant.PxMerchantSoapStub(new java.net.URL(PxMerchantSoap_address), this);
                _stub.setPortName(getPxMerchantSoapWSDDServiceName());
                return _stub;
            }
            if (com.payex.external.PxMerchant.PxMerchantSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxMerchant.PxMerchantSoap12Stub _stub = new com.payex.external.PxMerchant.PxMerchantSoap12Stub(new java.net.URL(PxMerchantSoap12_address), this);
                _stub.setPortName(getPxMerchantSoap12WSDDServiceName());
                return _stub;
            }
        }
