...
public class PxMerchantSoapProxy implements com.payex.external.PxMerchant.PxMerchantSoap {
  private String _endpoint = null;
  private com.payex.external.PxMerchant.PxMerchantSoap pxMerchantSoap = null;
  ...
  private void _initPxMerchantSoapProxy() {
    try {
      pxMerchantSoap = (new com.payex.external.PxMerchant.PxMerchantLocator()).getPxMerchantSoap();
  ...
  public com.payex.external.PxMerchant.PxMerchantSoap getPxMerchantSoap() {
    if (pxMerchantSoap == null)
      _initPxMerchantSoapProxy();
