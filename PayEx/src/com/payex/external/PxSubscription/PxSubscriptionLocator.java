...
public class PxSubscriptionLocator extends org.apache.axis.client.Service implements com.payex.external.PxSubscription.PxSubscription {
    ...
    private java.lang.String PxSubscriptionSoap12_address = "https://external.payex.com/pxsubscription/pxsubscription.asmx";
    ...
    public com.payex.external.PxSubscription.PxSubscriptionSoap getPxSubscriptionSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.payex.external.PxSubscription.PxSubscriptionSoap getPxSubscriptionSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxSubscription.PxSubscriptionSoap12Stub _stub = new com.payex.external.PxSubscription.PxSubscriptionSoap12Stub(portAddress, this);
    ...
    private java.lang.String PxSubscriptionSoap_address = "https://external.payex.com/pxsubscription/pxsubscription.asmx";
    ...
    public com.payex.external.PxSubscription.PxSubscriptionSoap getPxSubscriptionSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.payex.external.PxSubscription.PxSubscriptionSoap getPxSubscriptionSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxSubscription.PxSubscriptionSoapStub _stub = new com.payex.external.PxSubscription.PxSubscriptionSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.payex.external.PxSubscription.PxSubscriptionSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxSubscription.PxSubscriptionSoap12Stub _stub = new com.payex.external.PxSubscription.PxSubscriptionSoap12Stub(new java.net.URL(PxSubscriptionSoap12_address), this);
                _stub.setPortName(getPxSubscriptionSoap12WSDDServiceName());
                return _stub;
            }
            if (com.payex.external.PxSubscription.PxSubscriptionSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxSubscription.PxSubscriptionSoapStub _stub = new com.payex.external.PxSubscription.PxSubscriptionSoapStub(new java.net.URL(PxSubscriptionSoap_address), this);
                _stub.setPortName(getPxSubscriptionSoapWSDDServiceName());
                return _stub;
            }
        }
