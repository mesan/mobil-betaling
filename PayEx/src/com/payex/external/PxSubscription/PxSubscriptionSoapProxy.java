...
public class PxSubscriptionSoapProxy implements com.payex.external.PxSubscription.PxSubscriptionSoap {
  private String _endpoint = null;
  private com.payex.external.PxSubscription.PxSubscriptionSoap pxSubscriptionSoap = null;
  ...
  private void _initPxSubscriptionSoapProxy() {
    try {
      pxSubscriptionSoap = (new com.payex.external.PxSubscription.PxSubscriptionLocator()).getPxSubscriptionSoap();
  ...
  public com.payex.external.PxSubscription.PxSubscriptionSoap getPxSubscriptionSoap() {
    if (pxSubscriptionSoap == null)
      _initPxSubscriptionSoapProxy();
