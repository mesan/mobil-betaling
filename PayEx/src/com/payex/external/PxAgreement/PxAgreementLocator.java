...
public class PxAgreementLocator extends org.apache.axis.client.Service implements com.payex.external.PxAgreement.PxAgreement {
    ...
    private java.lang.String PxAgreementSoap12_address = "https://external.payex.com/pxagreement/pxagreement.asmx";
    ...
    public com.payex.external.PxAgreement.PxAgreementSoap getPxAgreementSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.payex.external.PxAgreement.PxAgreementSoap getPxAgreementSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxAgreement.PxAgreementSoap12Stub _stub = new com.payex.external.PxAgreement.PxAgreementSoap12Stub(portAddress, this);
    ...
    private java.lang.String PxAgreementSoap_address = "https://external.payex.com/pxagreement/pxagreement.asmx";
    ...
    public com.payex.external.PxAgreement.PxAgreementSoap getPxAgreementSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.payex.external.PxAgreement.PxAgreementSoap getPxAgreementSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.payex.external.PxAgreement.PxAgreementSoapStub _stub = new com.payex.external.PxAgreement.PxAgreementSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.payex.external.PxAgreement.PxAgreementSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxAgreement.PxAgreementSoap12Stub _stub = new com.payex.external.PxAgreement.PxAgreementSoap12Stub(new java.net.URL(PxAgreementSoap12_address), this);
                _stub.setPortName(getPxAgreementSoap12WSDDServiceName());
                return _stub;
            }
            if (com.payex.external.PxAgreement.PxAgreementSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.payex.external.PxAgreement.PxAgreementSoapStub _stub = new com.payex.external.PxAgreement.PxAgreementSoapStub(new java.net.URL(PxAgreementSoap_address), this);
                _stub.setPortName(getPxAgreementSoapWSDDServiceName());
                return _stub;
            }
        }
