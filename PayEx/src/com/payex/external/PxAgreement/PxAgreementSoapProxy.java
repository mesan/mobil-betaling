...
public class PxAgreementSoapProxy implements com.payex.external.PxAgreement.PxAgreementSoap {
  private String _endpoint = null;
  private com.payex.external.PxAgreement.PxAgreementSoap pxAgreementSoap = null;
  ...
  private void _initPxAgreementSoapProxy() {
    try {
      pxAgreementSoap = (new com.payex.external.PxAgreement.PxAgreementLocator()).getPxAgreementSoap();
  ...
  public com.payex.external.PxAgreement.PxAgreementSoap getPxAgreementSoap() {
    if (pxAgreementSoap == null)
      _initPxAgreementSoapProxy();
