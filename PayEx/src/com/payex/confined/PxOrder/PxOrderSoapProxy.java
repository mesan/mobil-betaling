...
public class PxOrderSoapProxy implements com.payex.confined.PxOrder.PxOrderSoap {
  private String _endpoint = null;
  private com.payex.confined.PxOrder.PxOrderSoap pxOrderSoap = null;
  ...
  private void _initPxOrderSoapProxy() {
    try {
      pxOrderSoap = (new com.payex.confined.PxOrder.PxOrderLocator()).getPxOrderSoap();
      if (pxOrderSoap != null) {
        if (_endpoint != null)
  ...
  public com.payex.confined.PxOrder.PxOrderSoap getPxOrderSoap() {
    if (pxOrderSoap == null)
      _initPxOrderSoapProxy();
    return pxOrderSoap;
  }
