...
public class PxOrderLocator extends org.apache.axis.client.Service implements test.com.payex.confined.PxOrder.PxOrder {
    ...
    private java.lang.String PxOrderSoap_address = "https://test-confined.payex.com/pxconfined/pxorder.asmx";
    ...
    public test.com.payex.confined.PxOrder.PxOrderSoap getPxOrderSoap() throws javax.xml.rpc.ServiceException {
    ...
    public test.com.payex.confined.PxOrder.PxOrderSoap getPxOrderSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.com.payex.confined.PxOrder.PxOrderSoapStub _stub = new test.com.payex.confined.PxOrder.PxOrderSoapStub(portAddress, this);
    ...
    private java.lang.String PxOrderSoap12_address = "https://test-confined.payex.com/pxconfined/pxorder.asmx";
    ...
    public test.com.payex.confined.PxOrder.PxOrderSoap getPxOrderSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public test.com.payex.confined.PxOrder.PxOrderSoap getPxOrderSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.com.payex.confined.PxOrder.PxOrderSoap12Stub _stub = new test.com.payex.confined.PxOrder.PxOrderSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.com.payex.confined.PxOrder.PxOrderSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                test.com.payex.confined.PxOrder.PxOrderSoapStub _stub = new test.com.payex.confined.PxOrder.PxOrderSoapStub(new java.net.URL(PxOrderSoap_address), this);
                _stub.setPortName(getPxOrderSoapWSDDServiceName());
                return _stub;
            }
            if (test.com.payex.confined.PxOrder.PxOrderSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                test.com.payex.confined.PxOrder.PxOrderSoap12Stub _stub = new test.com.payex.confined.PxOrder.PxOrderSoap12Stub(new java.net.URL(PxOrderSoap12_address), this);
                _stub.setPortName(getPxOrderSoap12WSDDServiceName());
                return _stub;
            }
        }
