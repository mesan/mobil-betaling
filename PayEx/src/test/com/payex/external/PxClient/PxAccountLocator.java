...
public class PxAccountLocator extends org.apache.axis.client.Service implements test.com.payex.external.PxClient.PxAccount {
    ...
    private java.lang.String PxAccountSoap_address = "https://test-external.payex.com/pxclient/pxaccount.asmx";
    ...
    public test.com.payex.external.PxClient.PxAccountSoap getPxAccountSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.com.payex.external.PxClient.PxAccountSoapStub _stub = new test.com.payex.external.PxClient.PxAccountSoapStub(portAddress, this);
    ...
    private java.lang.String PxAccountSoap12_address = "https://test-external.payex.com/pxclient/pxaccount.asmx";
    ...
    public test.com.payex.external.PxClient.PxAccountSoap getPxAccountSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.com.payex.external.PxClient.PxAccountSoap12Stub _stub = new test.com.payex.external.PxClient.PxAccountSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.com.payex.external.PxClient.PxAccountSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                test.com.payex.external.PxClient.PxAccountSoapStub _stub = new test.com.payex.external.PxClient.PxAccountSoapStub(new java.net.URL(PxAccountSoap_address), this);
                _stub.setPortName(getPxAccountSoapWSDDServiceName());
                return _stub;
            }
            if (test.com.payex.external.PxClient.PxAccountSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                test.com.payex.external.PxClient.PxAccountSoap12Stub _stub = new test.com.payex.external.PxClient.PxAccountSoap12Stub(new java.net.URL(PxAccountSoap12_address), this);
                _stub.setPortName(getPxAccountSoap12WSDDServiceName());
                return _stub;
            }
        }
