...
public class PxOrderSoapProxy implements test.com.payex.external.PxOrder.PxOrderSoap {
  private String _endpoint = null;
  private test.com.payex.external.PxOrder.PxOrderSoap pxOrderSoap = null;
  ...
  private void _initPxOrderSoapProxy() {
    try {
      pxOrderSoap = (new test.com.payex.external.PxOrder.PxOrderLocator()).getPxOrderSoap();
      if (pxOrderSoap != null) {
        if (_endpoint != null)
  ...
  public test.com.payex.external.PxOrder.PxOrderSoap getPxOrderSoap() {
    if (pxOrderSoap == null)
      _initPxOrderSoapProxy();
    return pxOrderSoap;
  }
