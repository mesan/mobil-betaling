...
public class PxOrderLocator extends org.apache.axis.client.Service implements test.com.payex.external.PxOrder.PxOrder {
    ...
    private java.lang.String PxOrderSoap_address = "https://test-external.payex.com/pxorder/pxorder.asmx";
    ...
    public test.com.payex.external.PxOrder.PxOrderSoap getPxOrderSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.com.payex.external.PxOrder.PxOrderSoapStub _stub = new test.com.payex.external.PxOrder.PxOrderSoapStub(portAddress, this);
    ...
    private java.lang.String PxOrderSoap12_address = "https://test-external.payex.com/pxorder/pxorder.asmx";
    ...
    public test.com.payex.external.PxOrder.PxOrderSoap getPxOrderSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.com.payex.external.PxOrder.PxOrderSoap12Stub _stub = new test.com.payex.external.PxOrder.PxOrderSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.com.payex.external.PxOrder.PxOrderSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                test.com.payex.external.PxOrder.PxOrderSoapStub _stub = new test.com.payex.external.PxOrder.PxOrderSoapStub(new java.net.URL(PxOrderSoap_address), this);
                _stub.setPortName(getPxOrderSoapWSDDServiceName());
                return _stub;
            }
            if (test.com.payex.external.PxOrder.PxOrderSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                test.com.payex.external.PxOrder.PxOrderSoap12Stub _stub = new test.com.payex.external.PxOrder.PxOrderSoap12Stub(new java.net.URL(PxOrderSoap12_address), this);
                _stub.setPortName(getPxOrderSoap12WSDDServiceName());
                return _stub;
            }
        }
